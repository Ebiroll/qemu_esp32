 ...
 */
typedef enum {
    L_SPI_HOST=0,                     ///< SPI1, SPI; Cannot be used in this driver!
    L_HSPI_HOST=1,                    ///< SPI2, HSPI
    L_VSPI_HOST=2                     ///< SPI3, VSPI
...
typedef void(*l_transaction_cb_t)(spi_lobo_transaction_t *trans);
...
typedef struct {
    ...
    l_transaction_cb_t pre_cb;        ///< Callback to be called before a transmission is started. This callback from 'spi_lobo_transfer_data' function.
    l_transaction_cb_t post_cb;       ///< Callback to be called after a transmission has completed. This callback from 'spi_lobo_transfer_data' function.
