...
{
  bitset(&z80ports_in[16],0,testbit(z80ports_in[9],3));
  bitset(&z80ports_in[16],1,testbit(z80ports_in[7],2));
  bitset(&z80ports_in[16],2,testbit(z80ports_in[6],5));
  bitset(&z80ports_in[16],3,testbit(z80ports_in[5],5));
  bitset(&z80ports_in[16],4,testbit(z80ports_in[4],2));
    
  bitset(&z80ports_in[17],0,testbit(z80ports_in[4],3));
  bitset(&z80ports_in[17],1,testbit(z80ports_in[2],6));//sym shift
  bitset(&z80ports_in[17],2,testbit(z80ports_in[5],3));
  bitset(&z80ports_in[17],3,testbit(z80ports_in[4],4));
  bitset(&z80ports_in[17],4,testbit(z80ports_in[4],5));

  bitset(&z80ports_in[18],0,testbit(z80ports_in[0],7) & testbit(z80ports_in[9],0) & testbit(z80ports_in[9],5) & testbit(z80ports_in[9],2)
       & testbit(z80ports_in[0],4) & testbit(z80ports_in[0],5));//SHIFT

  bitset(&z80ports_in[18],1,testbit(z80ports_in[2],3));
  bitset(&z80ports_in[18],2,testbit(z80ports_in[1],3));
  bitset(&z80ports_in[18],3,testbit(z80ports_in[1],5));
  bitset(&z80ports_in[18],4,testbit(z80ports_in[3],3));

  bitset(&z80ports_in[19],0,testbit(z80ports_in[2],5));//A
  bitset(&z80ports_in[19],1,testbit(z80ports_in[2],4));
  bitset(&z80ports_in[19],2,testbit(z80ports_in[1],4));
  bitset(&z80ports_in[19],3,testbit(z80ports_in[3],5));//F
  bitset(&z80ports_in[19],4,testbit(z80ports_in[3],4));

  bitset(&z80ports_in[20],0,testbit(z80ports_in[2],1));
  bitset(&z80ports_in[20],1,testbit(z80ports_in[2],2));
  bitset(&z80ports_in[20],2,testbit(z80ports_in[1],2));
  bitset(&z80ports_in[20],3,testbit(z80ports_in[3],1));
  bitset(&z80ports_in[20],4,testbit(z80ports_in[3],2));

  bitset(&z80ports_in[21],0,testbit(z80ports_in[0],0));
  bitset(&z80ports_in[21],1,testbit(z80ports_in[2],0));
  bitset(&z80ports_in[21],2,testbit(z80ports_in[1],0));
  bitset(&z80ports_in[21],3,testbit(z80ports_in[1],1));
  bitset(&z80ports_in[21],4,testbit(z80ports_in[3],0) & testbit(z80ports_in[9],2));

  bitset(&z80ports_in[22],0,testbit(z80ports_in[7],0) & testbit(z80ports_in[9],0));// 0

  bitset(&z80ports_in[22],1,testbit(z80ports_in[6],0));
  bitset(&z80ports_in[22],2,testbit(z80ports_in[5],1) & testbit(z80ports_in[9],5));
  bitset(&z80ports_in[22],3,testbit(z80ports_in[5],0) & testbit(z80ports_in[0],4));
  bitset(&z80ports_in[22],4,testbit(z80ports_in[4],0) & testbit(z80ports_in[0],5));

  bitset(&z80ports_in[23],0,testbit(z80ports_in[7],1));
  bitset(&z80ports_in[23],1,testbit(z80ports_in[6],2));
  bitset(&z80ports_in[23],2,testbit(z80ports_in[6],1));
  bitset(&z80ports_in[23],3,testbit(z80ports_in[5],2));
  bitset(&z80ports_in[23],4,testbit(z80ports_in[4],1));
}
...
//Serial.println(Port);
  ...
  if((Port & 0x00ff)  == 0x00fe)
  {
    ...
    {
      case 0xbf: kbdarrno = 16;break; 
      case 0x7f: kbdarrno = 17;break; 
      case 0xfe: kbdarrno = 18;break; 
      case 0xfd: kbdarrno = 19;break; 
      case 0xfb: kbdarrno = 20;break; 
      case 0xf7: kbdarrno = 21;break; 
      case 0xef: kbdarrno = 22;break; 
      case 0xdf: kbdarrno = 23;break; 
    }
//Serial.print("Keyb: ");
//Serial.println(kbdarrno);
...
// Awful keyboard emulation
// needs changing for spectrum, at present mapping is through the lynx keyboard ports
//
...
//  if key[SDLK_CAPSLOCK]) z80ports_in[0x0080] &= 0xF7;
  ...
  if  (k == 0x08){z80ports_in[18] &= 0xfe; z80ports_in[22] &= 0xfe; k_delay(4); return;}  // backspace
