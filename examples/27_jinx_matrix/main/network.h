...
#define CONFIG_UDP_PERF_WIFI_MODE_AP 0
#define CONFIG_UDP_PERF_SERVER 1
#define CONFIG_UDP_PERF_TX 0
#define CONFIG_UDP_PERF_WIFI_SSID "YOUR SSID IN network.h"
#define CONFIG_UDP_PERF_WIFI_PASSWORD "YOUR PASSWORD IN network.h"
#define CONFIG_UDP_PERF_SERVER_PORT 65506
#define CONFIG_UDP_PERF_PKT_SIZE 1500
...
#define EXAMPLE_PACK_BYTE_IS 0 //'a'
...
extern SemaphoreHandle_t xFrameSync;
